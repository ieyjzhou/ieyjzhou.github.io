...
------
1. Li S.$^\ddagger$, **Zhou, Y.$^\dagger$**, Liu X., Wang N., Wang J., Zhou B., Wang Z. (2025), Dynamic weight reinforcement learning method considering multiple factors in mobile edge computing system, **Neurocomputing**,  (accepted)
