...
------
1. Zhang, J., He, Z., **Zhou, Y.$^\dagger$**, Li. Y., Mixed integer programming approach for pallet packing and container loading of factory products, **Packaging Engineering**, Accept (In Chinese).
