...
------
1. Feng, P., Fu, J., Ge, Z., Wang, H., **Zhou, Y.$^\dagger$**, Zhou, B., & Wang, Z., (2021), Unsupervised semantic-aware adaptive feature fusion network for arrhythmia detection, **Information Sciences**, **[(In press)](https://doi.org/10.1016/j.ins.2021.09.046).** 
