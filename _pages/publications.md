...
2. Wang, H., Huang M., Wang H., Feng X., **Zhou, Y.$^\dagger$** (2021). Contract design for the fourth party logistics considering tardiness risk, **International Journal of Industrial Engineering Computations**, **[(In press: PDF)](http://www.growingscience.com/ijiec/IJIEC_2021_24.pdf).**
3. Wang, H., **Zhou, Y.$^\dagger$**, Zhou, B., Niu, X., Zhang, H., & Wang, Z., (2021). Interactive ECG annotating: An artificial intelligence method for smart ECG manipulation, **Information Sciences**, **[(In press)](https://www.sciencedirect.com/science/article/abs/pii/S0020025521009099).**
