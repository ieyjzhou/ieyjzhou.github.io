...
---
<div style="text-align: right"> $^\dagger$ corresponding author <br /> $^\ddag$ student under my (co-)supervision </div>


## International Journal Publications
------
1. Li S.$^\ddag$, **Zhou, Y.$^\dagger$**, Liu X., Wang N., Wang J., Zhou B., Wang Z. (2025), Dynamic weight reinforcement learning method considering multiple factors in mobile edge computing system, **Neurocomputing**,  (accepted)
