...
The above criteria and background are the basic requirments. Moreover, ensure that you have covered at least one of the listed skills.
- Programming language: C/C++; Java; Python; AMPL; Julia; R...
- Solver (IDE): GAMS; Cplex; Lingo; Gurobi; XPRESS; Matlab... 
- Optimization: linear/mixed integer/non-linear programming...
- Metaheuristics: genetic algorithm; tabu search; particle swarm optimization; variable neighborhood search.....
The following two criteria are not required (optional)：
