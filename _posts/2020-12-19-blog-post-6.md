...
1. An introduction to continuous optimization  Foundations and fundamental algorithms (2007, Studentlitteratur AB) - Copy 
...
1. Approximate-Dynamic-Programming-Solving-the-Curses-of-Dimensionality-2nd-Edition-Wiley-Series-in-Probability-and-Statistics- 
...
1. Computational-Methods-of-Linear-Algebra-Second-Edition-Pure-and-Applied-Mathematics-A-Wiley-Interscience-Series-of-Texts-Monographs-and-Tracts- 
1. Computational-Methods-of-Linear-Algebra 
1. Computing and Optimization
1. Constrained Optimization and Lagrange Multiplier Methods (1996, Athena Scientific)Dimitri P. Bertsekas, Dimitri P Bertsekas, Dimitri P Bertsekas -  
...
1. Introduction to Linear Programming with MATLAB (2018, Taylor & Francis, CRC Press_Chapman and Hall_CRC) 
1. Introduction to Mathematical Optimization
1. Introduction to Mathematical Optimization-Independently published (2019) 
...
1. Introduction to nonlinear optimization_ theory, algorithms, and applications with MATLAB 
...
1. Introductory Lectures on Convex Optimization  A Basic Course (2004, Springer US) [Applied Optimization 87] Yurii Nesterov (auth.) -  
1. Introductory Lectures on Convex Optimization [2004] 
1. Introductory Lectures on Convex Optimization_ A Basic Course-Springer (2003) 
...
1. Numerical Methods for Engineers Leif Rune Hellevik 
...
1. Optimization in Economic Theory -Oxford University Press, USA (1990) Cut and Print Version(cut) 
1. Optimization in Economic Theory -Oxford University Press, USA (1990) Cut and Print Version 
